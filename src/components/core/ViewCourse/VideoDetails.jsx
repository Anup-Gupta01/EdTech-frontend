                ...
                <div className="relative rounded-lg overflow-hidden">
                    ...
                    >
                        {videoEnded && (
                            <div
                                style={{
                                    backgroundImage: "linear-gradient(to top, rgba(0,0,0,1), rgba(0,0,0,0.7), rgba(0,0,0,0.5), rgba(0,0,0,0.1))",
                                }}
                                className="absolute inset-0 z-[100] flex h-full flex-col items-center justify-center gap-y-4 text-white"
                            >
                                <div className="flex flex-col items-center gap-4">
                                    {!completedLectures.includes(subSectionId) && (
                                        <IconBtn
                                            ...
                                            onclick={() => handleLectureCompletion()}
                                            text={!loading ? "Mark As Completed" : "Loading..."}
                                            customClasses="text-xl max-w-max px-6 py-2"
                                        />
                                    )}
                                    <IconBtn
                                        disabled={loading}
                                ...
                                <div className="mt-6 flex justify-center gap-x-4 text-xl">
                                    {!isFirstVideo() && (
                                        <button
                                            disabled={loading}
                                            onClick={goToPrevVideo}
                                            className='rounded-md bg-richblack-600 px-5 py-2 font-semibold transition-all duration-200 hover:bg-richblack-700'
                                        >
                                            Prev
                                        </button>
                                    )}
