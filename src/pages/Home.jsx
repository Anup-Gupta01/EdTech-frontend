...
const Home = () => {
    return (
        ...
        //                         The modern StudyVerse is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
        //                     </div>
        //                     <div className='w-[40%] '>
        //                         <CTAButton  active={true} linkto={"/signup"}>
        //                             <div>
  ...
  <div>
    ...
    <div className="relative mx-auto flex flex-col w-11/12 items-center text-white justify-between max-w-maxContent">
      <Link to={"/signup"}>
        <div className="mt-16 p-1 mx-auto rounded-full bg-richblack-700 font-bold text-richblack-200 transition-all duration-200 hover:scale-95 w-fit">
          <div className="flex flex-row items-center gap-rounded-full px-6 sm:px-10 py-[5px] transition-all duration-200 group-hover:bg-richblack-900">
            <p className="mr-2"> Become an Instructor</p>
            <FaArrowRight />
          </div>
        </div>
      ...
      <div className="text-center text-2xl sm:text-3xl md:text-4xl font-semibold flex mt-4">
        Empower Your Future with
        <HighLightText text={"Coding Skills"} />
      </div>

      <div className="mt-3 w-[90%] md:w-[80%] text-center text-sm sm:text-base md:text-lg font-semibold text-richblack-300">
        With our online coding courses, you can learn at your own pace, from
        anywhere in the world, and get access to a wealth of resources,
        including hands-on projects, quizzes, and personalized fedback from
        instructors.
      </div>

      <div className="flex flex-col sm:flex-row gap-4 sm:gap-7 mt-6">
        <CTAButton active={true} linkto={"/signup"}>
          Learn More
        </CTAButton>
        <CTAButton active={false} linkto={"/login "}>
      ...
      <div className="shadow-blue-200 mx-5 sm:mx-10 md:mx-20 my-12 w-full sm:w-[90%] md:w-auto">
    ...
    <div className="bg-white text-richblack-700">
      ...
      <div className="mx-5 sm:mx-10 md:mx-20 w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-6">
        <div className="flex flex-col md:flex-row gap-6 mb-10 mt-[70px] w-full">
          <div className="text-2xl sm:text-3xl md:text-4xl font-semibold md:w-[60%]">
            Get the Skills you need for a
            <HighLightText text={"Job that is in demand"} />
          </div>
          <div className="flex flex-col gap-6 md:gap-10 md:w-[30%]">
            <div className="text-sm sm:text-base md:text-[16px]">
              The modern StudyVerse dictates its own terms. Today, to be a
    ...
    <div className="w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white">
      ...
      <h2 className="text-center text-2xl sm:text-3xl md:text-4xl font-semibold mt-10 mb-10">
